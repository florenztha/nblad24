  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await smartChat({
        ...
        history: history,
        config: {
          systemInstruction: `You are the Nabila Prompt Generator AI Assistant, an expert in prompt engineering, content strategy, and AI creative tools. 
          The user's preferred language is ${language}. You MUST respond in this language.
          Help users optimize their prompts and understand how to use the various tools in Nabila Prompt Generator (Content Lab, Image Studio, Video Factory, etc.). Be professional, insightful, and helpful.`,
        }
      });
